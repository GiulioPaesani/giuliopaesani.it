...
const MiniTool = ({ label, icon }: MiniToolProps) => {
	return (
		<div className='group ease-in-out duration-200 hover:-translate-y-3 w-60 md:w-72 h-24 bg-primary-500 rounded-lg flex justify-start items-center gap-4 py-4 px-8'>
